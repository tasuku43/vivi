...
expects downstream claim, renew, follow, check, and write suggestions to carry
that same flag so a fake adapter can execute the suggested argv as-is. Runtime
