...
const required = [
  ...
  "docs/product/02-requirements.md",
  "docs/contracts/03-cli-or-api-contract.md",
  "docs/contracts/04-data-model.md",
  "docs/engineering/05-evaluation.md",
  "docs/engineering/06-implementation-plan.md",
  "docs/product/07-non-goals.md",
  "docs/contracts/08-provider-or-adapter-contracts.md",
  "docs/runbooks/09-codex-runbook.md",
  "docs/engineering/10-agent-context.md",
  "docs/engineering/11-agent-evaluation-loop.md",
  "docs/product/12-full-product-backlog.md",
  "docs/engineering/13-test-and-eval-strategy.md",
  "docs/architecture/14-architecture.md",
  "docs/architecture/15-security-model.md",
  "docs/architecture/20-go-backend-design.md",
