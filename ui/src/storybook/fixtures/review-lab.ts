...
export const reviewQueueDirectoryTree: FsNode[] = [
  dir("docs", [
    dir("docs/product", [
      fileNode("docs/product/01-product-brief.md", "markdown", 5_214),
      fileNode("docs/product/18-ux-acceptance-criteria.md", "markdown", 8_460),
    ]),
    dir("docs/ui-mocks", [
      fileNode(
      ...
      fileNode("docs/ui-mocks/index.html", "html", 12_285),
    ]),
  ]),
  dir("examples", [
    dir("examples/onboarding", [
      fileNode("examples/onboarding/index.html", "html", 4_802),
      fileNode("examples/onboarding/README.md", "markdown", 3_116),
    ]),
  ]),
  dir("packages", [
    dir("packages/agent-guide", [
      dir("packages/agent-guide/docs", [
        fileNode(
...
export const reviewQueueDirectoryChangedPaths = [
  "docs/product/01-product-brief.md",
  "docs/product/18-ux-acceptance-criteria.md",
  "docs/ui-mocks/43-review-queue-directory-organization.html",
  "docs/ui-mocks/index.html",
...
export const reviewQueueDirectoryOpenThreadCounts: Record<string, number> = {
  "examples/onboarding/index.html": 2,
};
