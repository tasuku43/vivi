...
function htmlPreviewPalette(theme: MermaidPreviewTheme) {
  if (theme === "light") {
    return {
      accent: "#2f8fa5",
      background: "#f4f7f8",
      codeBackground: "#edf4f6",
      codeText: "#17242a",
      commentLine: "rgba(57,143,118,.32)",
      commentText: "#32745d",
      commentTint: "rgba(57,143,118,.11)",
      commentTintActive: "rgba(57,143,118,.18)",
      line: "#cfdee5",
      muted: "#6d7f87",
      panel: "#ffffff",
      softLine: "rgba(23,36,42,.08)",
      text: "#17242a",
    };
  }
  ...
  return {
    accent: "#67b8c7",
    background: "#0b1218",
    codeBackground: "#061018",
    codeText: "#eef4f4",
    commentLine: "rgba(139,214,195,.36)",
    commentText: "#a9e3d5",
    commentTint: "rgba(139,214,195,.12)",
    commentTintActive: "rgba(139,214,195,.2)",
    line: "#273944",
    muted: "#8ea0a7",
    panel: "#111a21",
    softLine: "rgba(238,244,244,.07)",
    text: "#eef4f4",
  };
}
